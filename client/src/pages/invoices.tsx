...
const SEED_INVOICES: Invoice[] = [
  {
    ...
    clientEmail: "finance@meridian.com",
    clientAddress: "100 Health Plaza, Boston, MA 02110",
    ...
    lineItems: JSON.stringify([
      {
        description: "Executive Search Fee — Chief Financial Officer",
        quantity: 1,
        unitPrice: 87500,
        amount: 87500,
      },
    ...
    dueDate: "2025-02-14",
    paidDate: "2025-02-01",
    notes: "Placement fee per signed engagement letter dated Nov 2024.",
    terms: "Net 30",
    qbInvoiceId: "QB-INV-001",
    qbSyncedAt: "2025-01-15T10:00:00Z",
    createdAt: "2025-01-15T09:00:00Z",
    updatedAt: "2025-02-01T12:00:00Z",
  },
  {
    id: 2,
    invoiceNumber: "HC-2025-002",
    status: "sent",
    clientName: "DataPulse Analytics",
    clientEmail: "ap@datapulse.com",
    clientAddress: "500 Tech Blvd, San Francisco, CA 94105",
    ...
    lineItems: JSON.stringify([
      {
        description: "Executive Search Fee — Chief Technology Officer",
        quantity: 1,
        unitPrice: 105000,
        amount: 105000,
      },
    ...
    dueDate: "2025-03-07",
    notes: "Net 30 from placement date.",
    terms: "Net 30",
  ...
  {
    id: 3,
    invoiceNumber: "HC-2025-003",
    status: "partial",
    clientName: "BrightPath Health",
    clientEmail: "finance@brightpath.com",
    clientAddress: "200 Care Way, Chicago, IL 60601",
    ...
    lineItems: JSON.stringify([
      {
        description: "Executive Search Fee — Chief Operating Officer",
        quantity: 1,
        unitPrice: 83600,
        amount: 83600,
      },
    ...
    dueDate: "2025-03-14",
    notes: "50% deposit received. Balance due on start date.",
    terms: "Net 30",
  ...
  {
    id: 4,
    invoiceNumber: "HC-2025-004",
    status: "paid",
    clientName: "Summit Capital",
    clientEmail: "ap@summitcap.com",
    clientAddress: "1 Summit Plaza, New York, NY 10001",
    ...
    lineItems: JSON.stringify([
      {
        description: "Executive Search Fee — VP of Finance",
        quantity: 1,
        unitPrice: 58000,
        amount: 58000,
      },
    ...
    qbSyncedAt: "2025-03-01T10:00:00Z",
    createdAt: "2025-03-01T09:00:00Z",
    updatedAt: "2025-03-20T14:00:00Z",
  },
  {
    id: 5,
    invoiceNumber: "HC-2025-005",
    status: "draft",
    clientName: "VitalWell Consumer Health",
    clientEmail: "finance@vitalwell.com",
    clientAddress: "300 Wellness Ave, Austin, TX 78701",
    ...
    lineItems: JSON.stringify([
      {
        description: "Executive Search Fee — Chief Marketing Officer",
        quantity: 1,
        unitPrice: 77500,
        amount: 77500,
      },
    ...
    dueDate: "2025-04-17",
    notes: "Draft pending client sign-off on engagement letter.",
    terms: "Net 30",
  ...
  {
    id: 6,
    invoiceNumber: "HC-2025-006",
    status: "sent",
    clientName: "TalentForge Ventures",
    clientEmail: "ap@talentforge.com",
    clientAddress: "150 Venture Way, Austin, TX 78702",
    ...
    lineItems: JSON.stringify([
      {
        description: "Executive Search Fee — Head of Revenue Operations",
        quantity: 1,
        unitPrice: 58300,
        amount: 58300,
      },
  ...
  {
    id: 7,
    invoiceNumber: "HC-2025-007",
    status: "paid",
    clientName: "CarePoint Health",
    clientEmail: "billing@carepoint.com",
    clientAddress: "400 Care Center Dr, Nashville, TN 37201",
    ...
    lineItems: JSON.stringify([
      {
        description: "Executive Search Fee — Chief People Officer",
        quantity: 1,
        unitPrice: 112500,
        amount: 112500,
      },
    ...
    terms: "Net 30",
    qbInvoiceId: "QB-INV-007",
    qbSyncedAt: "2025-04-05T10:00:00Z",
    createdAt: "2025-04-05T09:00:00Z",
    updatedAt: "2025-04-25T16:00:00Z",
  },
  {
    id: 8,
    invoiceNumber: "HC-2025-008",
    status: "void",
    clientName: "Acme Health",
    clientEmail: "finance@acmehealth.com",
    clientAddress: "750 Medical Center Pkwy, Atlanta, GA 30301",
    ...
    dueDate: "2025-05-31",
    notes: "Voided — search cancelled by client before placement.",
    terms: "Net 30",
...
export default function Invoices() {
  ...
  const invoices: Invoice[] = rawInvoices.length ? rawInvoices : SEED_INVOICES;
